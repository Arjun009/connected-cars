...
l1r=['Highway.mp4'] #[#"videoplayback.mp4",'Highway.mp4']
        ...
        if(c>1):
            ...
            with open('manipalrun\\temp.jpg', 'rb') as fp:
                response = requests.post(
                    ...
                    headers={'Authorization': 'Token 3aa052e68c7d00f0401e3a7f350dab103c0a9882'})
                try:
...
class VideoCamera1(object):
    def __init__(self):
        self.video = cv2.VideoCapture('Downloads/1t.MP4')#'http://commondatastorage.googleapis.com/gtv-videos-bucket/sample/BigBuckBunny.mp4')
...
class VideoCamera3(object):
    def __init__(self):
        self.video = cv2.VideoCapture('Downloads/3.MP4')#'http://commondatastorage.googleapis.com/gtv-videos-bucket/sample/BigBuckBunny.mp4')
...
class VideoCamera4(object):
    def __init__(self):
        self.video = cv2.VideoCapture('Downloads/4.MP4')#'http://commondatastorage.googleapis.com/gtv-videos-bucket/sample/BigBuckBunny.mp4')
            ...
            for i in gl.number:
                if i in gl.plate:
                    ...
                    if i in gl.stack:
                        ...
                        gl.stack.append(i)
                        try:
                            sms.sendPostRequest(URL, 'LP9P1EGV64XY1FJGZVFWAEUETDFPD2QG', '9TRUBVP7ABCFB7O4', 'stage', mob, user, 'Move to the left Emergency is coming' )
                        except:
                            return [
